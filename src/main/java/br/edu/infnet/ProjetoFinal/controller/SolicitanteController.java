...
@GetMapping
    ...
    @PutMapping
    public void update(ArrayList<Pedido> pedido){
        logger.info("Metodo update iniciado: ");

        Solicitante Marcos = Solicitante.builder().nome("MarcosAlterando").cpf("alterado").email("alterado@hotmail.com").pedidos(pedido).build();
